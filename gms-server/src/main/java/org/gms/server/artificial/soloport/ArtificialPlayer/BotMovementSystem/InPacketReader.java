...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementStructures.MovementPacketRaw;
...
public class InPacketReader {
    ...
    public static void recordMovementInPacketToBinaryAndCSV(InPacket p) {
        ...
        InPacket packet = new ByteBufInPacket(Unpooled.wrappedBuffer(p.getBytes()));
        packet.seek(p.getPosition());

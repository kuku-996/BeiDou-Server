...
final class BotFallbackMovementManager {
    ...
    private static boolean canDirectlyAttachToRope(Point botPos, Rope rope) {
        ...
        // without first going airborne 鈥?same "press DOWN to grab from top"
        // motion as the real org.gms.client. attachY snaps to rope.topY in the caller.
        return botPos != null
                && rope != null
    ...
    private static boolean shouldUseDownJump(BotMovementState entry, Point botPos, Point targetPos, Rope rope) {
        ...
        // the bot drops into open water 鈥?no landing foothold exists or is required.

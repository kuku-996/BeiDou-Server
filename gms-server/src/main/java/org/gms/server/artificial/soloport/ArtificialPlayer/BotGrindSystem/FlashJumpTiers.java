...
// flavor knob 鈥?a Hermit still leveling Flash Jump dashes visibly shorter than a Night Lord 鈥?resolved
...
public final class FlashJumpTiers {
    ...
    // Non-FLASH_JUMP jobs return 1 (harmless 鈥?only FLASH_JUMP-style bots ever dash).

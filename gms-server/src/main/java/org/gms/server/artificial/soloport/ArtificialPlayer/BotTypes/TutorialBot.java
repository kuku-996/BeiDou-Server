...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeCommands;
import org.gms.server.artificial.soloport.server.BotTiming;
import org.gms.server.artificial.soloport.server.NXCodeManager;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.DropCommands.botLootSelectedItems;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.DropCommands.botThrowEquipsInARow;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.VFXCommands.botScrollSuccess;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotHelpers.convertItemIdToName;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotLogic.checkForItemOnFloor;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotLogic.readPlayerEquipBySlotName;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotLogic.waitForPlayerInRange;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.pathFinderBeta;
...
public class TutorialBot extends BotSM {
    ...
    // sequential script must run on its own tick 鈥?a chain + guessed waitFor
    ...
    // Deliberate synchronous choreography 鈥?dialogue durations are YAML-driven.

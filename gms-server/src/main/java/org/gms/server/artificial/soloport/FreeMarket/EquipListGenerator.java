...
import org.gms.server.artificial.soloport.itemPool.ItemNode;

import java.util.*;

import static org.gms.server.artificial.soloport.FreeMarket.FMEconomyManager.multiplyWzPriceByJobStyle;
import static org.gms.server.artificial.soloport.itemPool.ItemInformationProviderUtilities.getJobStyleFromItemId;
import static org.gms.server.artificial.soloport.itemPool.ItemInformationProviderUtilities.getRandomEquipType;
import static org.gms.server.artificial.soloport.itemPool.ItemInformationProviderUtilities.getReqJobViaJobStyle;
import static org.gms.server.artificial.soloport.itemPool.ItemInformationProviderUtilities.getWzPrice;
import static org.gms.server.artificial.soloport.itemPool.ItemInformationProviderUtilities.selectWeightedRandom;
import static org.gms.server.artificial.soloport.itemPool.QuantitySelector.distributedTierSelector;
import static org.gms.server.artificial.soloport.itemPool.UpgradeSimulator.ScrollGivenItem;
import static org.gms.server.artificial.soloport.itemPool.UpgradeSimulator.checkIfEquipIsScrollable;
import static org.gms.server.artificial.soloport.itemPool.UpgradeSimulator.getEquipMarketValue;
import static org.gms.server.artificial.soloport.itemPool.ItemSelector.getRandomItemFull;
import static org.gms.server.artificial.soloport.itemPool.ItemSelector.pickRandomVariantId;

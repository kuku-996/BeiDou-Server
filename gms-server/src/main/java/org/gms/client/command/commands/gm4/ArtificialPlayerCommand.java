...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotAttackSystem.BotBuffConfig;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotAttackSystem.BotBuffDriver;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotAttackSystem.BotBuffEffects;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.MegaphoneCommands;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotDecoratorSystem.BotDecorateBody;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotDecoratorSystem.BotDecorateEquips;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotDecoratorSystem.BotDecorateNX;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementStructures.MovementRecording;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMessagingSystem.CharacterStorage;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTypes.Blackjack.BlackjackDealerBot;
...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotGrindSystem.RestSpotFinder;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotPartySystem.BotPartyCommands;
...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMessagingSystem.QueueMonitor;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.DropCommands.botLoot;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.DropCommands.botLootLocation;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.DropCommands.botLootOwnerItems;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.DropCommands.botLootTargetCharactersItems;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.WarpCommands.botEnterPortalDropDown;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.SocialCommands.BotChatbubbleTyping;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.SocialCommands.displayPlayerChatCommands;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.SocialCommands.expirePlayerChatCommands;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.SocialCommands.BotSpeak;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.SocialCommands.displayPlayerChatCommands;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.DropCommands.botThrowToOwnerMeso;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.WarpCommands.botWarpMapOnPortal;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCustomization.EquipBot;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.InPacketReader.getMovementRecording;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.BotMoveStream;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotGeneration.removeBotFromServer;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotGeneration.warpBotToLocation;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotHelpers.convertItemIdToName;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotLogic.readPlayerCashEquipBySlotName;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotLogic.readPlayerEquipBySlotName;
//import static org.gms.server.artificial.soloport.ArtificialPlayer.BotLogic.readPlayersEquip;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.BLACKJACK_DEALER;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.DICE_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.FM_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.GACHA_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.HENESYS_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.OPQ_BOT;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.SCROLL_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.GAME_ZONE_HOST_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.DROP_GAME_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.HENESYS_JQ_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.TUTORIAL_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.BotType.TEST_ATTACK_BOT;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.convertBotType;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.manuallyStartBot;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTypeManager.manuallyStopBot;
import static org.gms.server.artificial.soloport.DebugUtilities.debugprint;
import static org.gms.server.artificial.soloport.server.NXCodeManager.createCompleteNXCode;
import static org.gms.server.artificial.soloport.server.SoloMaplingUtilities.getMapleMapById;
import static org.gms.server.artificial.soloport.server.SoloMaplingUtilities.isInteger;
...
//                testCygnusHint(c.getPlayer(), c);
    ...
    public static void handleNumberedCommand(String input, int input2, Client c) {
        ...
        switch (input.toLowerCase()) {
            ...
            case "trainbot":
            case "trainingbot":
                // convert (stop鈫抯et鈫抯tart) so the macro FSM ticks immediately on an already-running bot
                convertBotType(fakechar, BotTypeManager.BotType.TRAINING_BOT);
                player.yellowMessage("Bot " + fakechar.getId() + " is now a TrainingBot (town鈫攇rind loop).");
                break;
            case "breaknow": {
...
//                break;
    ...
    /*
     * !bot trainhere <job> [level] [count] 鈥?spawn N TrainingBots of a SPECIFIC job at your position and pin
    ...
    private static void handleTrainHere(String[] params, Client c) {
        ...
        if (map == null || MapMobIndex.level(map.getId()) < 0) {
            player.yellowMessage("Stand on a map WITH MOBS (not a town) 鈥?'grind here' needs mobs on the map.");
            return;
        }
        ...
        for (int i = 0; i < count; i++) {
            ...
            // path !bot spawn uses) 鈥?re-decorating after createBot left the bot showing its base look.
    ...
    /*
     * !bot grindstyle <cid|map> <camp|patrol|roam|stack|auto> 鈥?force a TrainingBot's grind archetype ('map' = every

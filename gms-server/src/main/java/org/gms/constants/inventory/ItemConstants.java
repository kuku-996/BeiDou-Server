...
public final class ItemConstants {
    ...
    /** Returns the v83 visible equipment slot used by artificial-player decoration. */
    public static int getEquipSlotType(final int itemId) {
        int type = itemId / 10000;
        if (type >= 130 && type <= 149) {
            return 11;
        }
        return switch (type) {
            case 100 -> 1;

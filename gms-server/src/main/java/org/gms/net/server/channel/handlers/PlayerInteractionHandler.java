...
import org.gms.server.artificial.soloport.FreeMarket.ShopOfferSystem.OfferParser;
import org.gms.server.artificial.soloport.FreeMarket.ShopOfferSystem.ShopOfferSystem;
import org.gms.server.artificial.soloport.FreeMarket.ShopOfferSystem.ShopOfferWelcome;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeConversation;
        ...
        try {
            ...
            if (mode == Action.CREATE.getCode()) {
                ...
                if (chr.getTrade() != null) {
                    ...
                    BotTradeConversation.onPlayerTradeChat(chr, chatMsg);

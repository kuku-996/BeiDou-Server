...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.InPacketReader;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands;
import org.gms.server.artificial.soloport.ArtificialPlayer.TestMethods;
import org.gms.server.artificial.soloport.server.ExecutorServiceManager;
import org.gms.server.artificial.soloport.server.SoloMaplingUtilities;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.WarpCommands.botMoveMap;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.BotIdleStandingUpdate;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.botFallDownPacket;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.findFootHoldId;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.interruptBotMovement;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.testInterruptMovement;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.testInterruptPathfinder;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.InPacketReader.setMoveDataRecording;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.InPacketReader.setMovementDataRecordingMapId;
import static org.gms.server.artificial.soloport.ArtificialPlayer.TestMethods.botmovetest;
    ...
    public static void handleNumberedCommand(String input, int input2, Client c) {
        ...
        switch (input.toLowerCase()) {
            ...
            case "getbotpos":
                ...
                player.yellowMessage("Bot " + fakechar.getId() + " 鈥?Pos: (" + pos.x + ", " + pos.y + "), FH: " + botFh + ", Map: " + botMapId);
                debugprint("Bot " + fakechar.getId() + " 鈥?Pos: " + pos + ", FH: " + botFh + ", Map: " + botMapId);
                break;
            case "interrupt":
            case "stop":
            ...
            case "faceme":
                ...
                break;
            case "wander":
                org.gms.server.artificial.soloport.ArtificialPlayer.BotWanderSystem.BotWanderSystem.start(fakechar);
                player.yellowMessage("Bot " + fakechar.getId() + " wandering this map");
                break;
            case "wandernear":
                // loiter near your X (radius 150) - the "near an NPC/object" mode
                org.gms.server.artificial.soloport.ArtificialPlayer.BotWanderSystem.BotWanderSystem.start(fakechar, c.getPlayer().getPosition().x, 150);
                player.yellowMessage("Bot " + fakechar.getId() + " wandering near you (r=150)");
                break;
            case "wanderstop":
                org.gms.server.artificial.soloport.ArtificialPlayer.BotWanderSystem.BotWanderSystem.stop(fakechar);

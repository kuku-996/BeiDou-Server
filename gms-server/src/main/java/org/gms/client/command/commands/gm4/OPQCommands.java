...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTypes.OPQ.OPQBot.OPQBotState;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTypes.OPQ.OPQConstants;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTypes.OPQ.OPQOrchestrator;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTypes.OPQ.OPQSharedContext;
    ...
    public static void handleDirectCommand(String input, Client c) {
        switch (input.toLowerCase()) {
            ...
            case "start":
                ...
                player.yellowMessage("OPQ run started 鈥?pqActive=true, phase=RECRUITMENT");
                break;
            case "reset":
                OPQOrchestrator.getInstance().shutdownRun();
                player.yellowMessage("OPQ context reset 鈥?pqActive=false");
                break;
            case "list":
                printList();
                break;

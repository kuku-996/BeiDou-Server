...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotAttackSystem.BotAttackData;
import org.gms.util.PacketCreator;

import java.util.Collections;
import java.util.Map;

import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.facingLeft;
 ...
 * damage application 鈥?when the swing should also hit a reactor or monster,
 ...
 *
 * The body-action id MUST match the equipped weapon class 鈥?a 1H swingO1 on a polearm
...
public final class BotAttack {
    ...
    public static void basicSwing(Character chr) {
        ...
        Map<Integer, java.util.List<Integer>> emptyTargets = Collections.emptyMap();

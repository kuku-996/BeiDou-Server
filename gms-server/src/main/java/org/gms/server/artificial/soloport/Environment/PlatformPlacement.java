...
// commands 鈥?it's placement mechanics, not world-startup logic, which is why it lives apart from
...
public class PlatformPlacement {
    ...
    // Note: first use puts the bot under dynamic control for good 鈥?it holds the shared movement

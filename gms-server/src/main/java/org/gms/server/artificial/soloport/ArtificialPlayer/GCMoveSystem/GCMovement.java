...
/*
 * Public fa莽ade for GCMoveSystem 鈥?the GreenCat dynamic (calculation-based) movement engine.
 ...
 * 
 *   .move(Character, int, int) 鈥?walk/jump/climb to a point on the current map.
 *   .follow(Character, Character) 鈥?dynamically tail a character.
 * 
...
public final class GCMovement {
    ...
    // 鈹€鈹€ Lifecycle 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    // 鈹€鈹€ Commands 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    /* Dynamically tail a character 鈥?including ACROSS maps (travels to the target's map when they
     ...
     * teleport 鈥?no MP/skill checks here (bots are decoration). */
     ...
     * dash cap (FlashJumpTiers; 1 = full maxed dash) 鈥?the platform fit may downshift under it so a small
    ...
    // 鈹€鈹€ Package helpers (used by GCTravel / GCFollow) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    /* GCFollow: target is on the bot's map 鈥?arm same-map follow (the driver does the walking). */
    ...
    /* GCFollow: target is on another map 鈥?pause same-map follow while the bot travels there. */
    ...
    /* GCFollow: the follow session ended (target gone) 鈥?clear follow state. */
    ...
    // 鈹€鈹€ Cross-map travel (GCTravel) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    /*
     * Travel to another map and then walk to (x,y) on it 鈥?e.g. "come to where I am".
    ...
    public static void travelTo(Character bot, int mapId, int x, int y, java.util.function.Consumer<Boolean> onDone) {
        ...
        if (bot.getMap() != null && bot.getMapId() == mapId) {
            move(bot, x, y, arrive); // already on the map 鈥?just navigate to the spot
            return;
        }
        GCTravel.travel(bot, mapId, ok -> {
            if (ok) {
                move(bot, x, y, arrive); // arrived on the destination map 鈥?now walk to the spot
            } else if (onDone != null) {
                onDone.accept(false);
            }
        });
    ...
    /* Mark the bot as actively grinding so the movement layer's grind-specific guards engage 鈥?chiefly
    ...
    public static void setGrinding(Character bot, boolean grinding) {
        ...
        if (st != null) {
            ...
            if (grinding) {
                // A training episode is deliberately ground-only.  Clear any
                // rope state left by travel before the combat loop can issue a
                // movement fragment for it.
                st.resting = false;
                if (st.climbing) {
                    BotMovementManager.jumpOffRope(st, bot, 0);
                }
            }
        }
    }
    ...
    /* True while the bot is climbing a rope/ladder as part of a committed navigation edge 鈥?i.e. the
    ...
    // 鈹€鈹€ Idle fidget primitives (organic liveliness) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    // jumpInPlace (always vertical), a non-zero dx launches a real moving arc 鈥?the manager/physics
    // already carry the 卤walkStep horizontal velocity. Used by the grind brain's jump-attack so
    ...
    /* Flip the bot's facing (left鈫攔ight) while idle; the driver renders the new stand stance. */
    ...
    // 鈹€鈹€ Observability (LOD tier gate for callers) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€

    /*
     * True when a real player is on mapId 鈥?i.e. the map is "observed" (FULL tier). This is
     ...
     * window), or "coarse" (unobserved). Diagnostics 鈥?see !gcmove lod train.
     */
    ...
    // 鈹€鈹€ Spatial terrain queries (generic nav-graph reads; used by grind-spot finding, placement, 鈥? 鈹€鈹€
    ...
    public static java.util.Map<Integer, Integer> mapsWithinHopsByDepth(int fromMapId, int maxHops) {
        ...
        while (!frontier.isEmpty() && depth < maxHops) {
            ...
            for (int level = frontier.size(); level > 0; level--) {
                ...
                // curated scripted warps (subway entrance, etc.) 鈥?a local hop, unlike taxi/ferry
                for (int next : org.gms.server.artificial.soloport.ArtificialPlayer.BotTravelSystem.BotScriptedWarp.destinations(current)) {
                    if (seen.add(next)) {
                        out.put(next, depth);
                        frontier.add(next);
                    }
    ...
    // 鈹€鈹€ LOD measurement tooling (M0) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    // 鈹€鈹€ Diagnostics (Phase-2 gate) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
     ...
     * proof point 鈥?it exercises the WZ geometry load + physics-simulation edge discovery.
     */
    ...
    // 鈹€鈹€ Internal driver callback 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€

    /* Driver hook: a move was abandoned (no progress / unreachable) 鈥?drop its callback unfired. */

...
public record SpotStack(
        ...
        int x0, int x1,             // union of member X extents (anchor 卤 radius) 鈥?the tether's horizontal bounds
        int topY, int bottomY,      // anchor y of the top / bottom member ledges
        int totalFeed,              // sum of member sameLedgeSpawnCount 鈥?the stack's harvestable feed

    ...
    static List<String> stats() {
        ...
        for (BotMovementState st : states) {
            ...
            if (ObserverTracker.isFull(mapId)) {
                ...
                tierDwell++; // recently observed 鈥?held at full physics through the hysteresis dwell
            } else {
                tierCoarse++;
            }
        }
        ...
        out.add("(watch the JVM/host CPU at this bot count 鈥?that is the M0 measurement)");
        return out;
    }

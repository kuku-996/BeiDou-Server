...
final class GrindStylePolicy {
    ...
    // feed (and a floor) before STACK beats CAMP 鈥?a stack always contains its members, so dominance
    ...
    // camps the best single ledge 鈥?same map, different style per class, which is the point (a mage

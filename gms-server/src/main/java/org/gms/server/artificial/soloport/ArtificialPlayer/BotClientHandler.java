...
import org.gms.server.artificial.soloport.server.SoloMaplingConstants.GameConstants;
...
public class BotClientHandler {
    ...
    /**
     * Constructs the one shared headless bot org.gms.client. Idempotent 鈥?safe to call

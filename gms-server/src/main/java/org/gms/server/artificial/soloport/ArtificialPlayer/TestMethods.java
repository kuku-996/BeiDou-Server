...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementStructures.TimeCoordinatePair;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.WarpCommands.botEnterFMRoom;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.WarpCommands.botExitFMRoom;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotGeneration.getConsoleBot;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.InPacketReader.getMovementRecording;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.BotMoveStreamHelper;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.BotMoveStreamOffset;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.BotMoveStreamUntilStopPoint;
//import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.injectIntoMovementStreamWithEndPoint;
//import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.NavigationSystem.FMMovementCommands.MoveBetweenTwoDoorsSameRow;
//import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.NavigationSystem.FMMovementCommands.moveBetweenFMRowsUp;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.NavigationSystem.FMMovementCommands.moveToFMDoor;
//import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.NavigationSystem.PathFinderbeta.pathFinderTest;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.NavigationSystem.PathFinder.coordPathBuilder;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.NavigationSystem.PathFinder.coordPathSplitter;
import static org.gms.server.artificial.soloport.DebugUtilities.debugprint;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.MapleMessengerCommands.addBotToMessenger;

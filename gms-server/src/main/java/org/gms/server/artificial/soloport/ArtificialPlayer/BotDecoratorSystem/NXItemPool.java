...
public class NXItemPool {
    ...
    public static synchronized void load() {
        ...
        try {
            ...
            if (EquipMetadataCache.isInitialized()) {
                ...
                System.out.println("[NXItemPool]   EquipMetadataCache not initialized 鈥?"
    ...
    /**
     * Force a reload 鈥?clears existing pools and re-reads YAML + cache.
     * Useful for hot-reloading curated lists without restarting the org.gms.server.
     */

...
//     because the map BFS drops its own origin 鈥?this registry does not gate it.
...
//     (harder mobs), never back up toward town 鈥?enforced by a raised admission floor in doDecide.
...
public final class DeepHub {
    ...
    private static final Map<Integer, Info> HUBS = Map.of(
            ...
            // one-directional 鈥?its high-level cohort only trains DEEPER, never back up toward Ludibrium town.

package org.gms.server.artificial.soloport.ArtificialPlayer.BotTypes.Blackjack;
...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotCustomization;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotHelpers.adjustCenterPositionXAxis;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotLogic.announceBetString;
...
public class BlackjackDealerBot extends BotSM {
    ...
    private void handlePayout() {
        ...
        // All payouts settled 鈥?now safe to clean up cards and start the next round.
        cleanupAllCards();
    ...
    private void processAllPlayersBets() {
        ...
        for (int i = 0; i < table.getPlayerCount(); i++) {
            BlackjackPlayer player = table.getPlayer(i);
            if (i == 0) {
                // Dealer 鈥?just record origin location
    ...
    public void displayCommands(Character chr) {
        // Inquiry hint 鈥?shown when a player calls the dealer by name.
    ...
    // TODO: BotSwapItemAtLocation 鈥?not yet available in new architecture.

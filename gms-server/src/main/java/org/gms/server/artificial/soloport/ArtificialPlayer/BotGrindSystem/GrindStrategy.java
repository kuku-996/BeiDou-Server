...
// shares across styles 鈥?sticky target, engage flags, skill-move/turn/kite cadences, loot, rope
// recovery, the watchdog heartbeat 鈥?lives on GrindBrain and is accessed directly (same package).
// Ours (SoloMapling).
interface GrindStrategy {
    ...
    // True when this map is full for this style (every spot claimed / seek range contested) 鈥?the
    ...
    // The [x0, x1] X range movement may target this tick 鈥?the shared engage beats (turn step, kite

package org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.NavigationSystem;
...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementStructures.MovementRecordingRaw;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementStructures.StartEndPair;
...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.PlayerReaction;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.PlayerSnapshot;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.InPacketReader.getMovementRecordingRaw;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.MidMovementCheck;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.executeMovement;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.NavigationSystem.NavigationElement.parseNavigationType;
    ...
    private void executeElementsWithRepath(int mapId, List<NavigationElement> elements,
        ...
        for (int i = 0; i < elements.size(); i++) {
            ...
            try {
                ...
                if (interrupted) {
                    // Stop-react happened 鈥?re-pathfind from current position to original endpoint

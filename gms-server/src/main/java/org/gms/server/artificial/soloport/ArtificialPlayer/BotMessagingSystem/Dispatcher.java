package org.gms.server.artificial.soloport.ArtificialPlayer.BotMessagingSystem;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMessagingSystem.CharacterStorage.checkIfInvisibleBot;
...
//        log("Dispatcher: RUN");
    ...
    private void handleExistingBotSession(BotSM bot, ChatMessage message) {
        ...
        // follow-up would have arrived 鈥?BotOptionMenu.poll drains it on the bot's next tick with the same

...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotAttackSystem.ThrowingStarSelector;
...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeHandler;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeInventory;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeLogic;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeSM;
import org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeWants;
import org.gms.server.artificial.soloport.ArtificialPlayer.GCMoveSystem.LodCounts;
import org.gms.server.artificial.soloport.server.EventMessageSystem.BotEventBuffer;
import org.gms.server.artificial.soloport.server.EventMessageSystem.EventBus;
import org.gms.server.artificial.soloport.server.EventMessageSystem.EventSubscriber;
import org.gms.server.artificial.soloport.server.EventMessageSystem.GameEvent;

import org.gms.server.artificial.soloport.server.BotTickService;

import java.util.Collection;
import java.util.List;

import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.SocialCommands.botClearChalkboard;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMessagingSystem.CharacterStorage.botLoggedIn;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeLogic.clearTradeRequest;
...
public abstract class BotSM implements EventSubscriber {
    ...
    private final Runnable tickRunnable = () -> {
        try {
            ...
            org.gms.server.artificial.soloport.server.BotPerfStats.MACRO_TICKS.increment();
            updateState();
        } catch (Exception e) {
    ...
    // 鈹€鈹€ Waiting without sleeping (Fable Phase 4) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
//                }
    ...
    public synchronized void nudgeSoon(long initialDelayMs) {
        ...
        lastNudgeMs = now;
        org.gms.server.artificial.soloport.server.BotPerfStats.NUDGES.increment();

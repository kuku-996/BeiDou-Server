...
/*
 * Analytic plan executor 鈥?the cheap path for unobserved bots. It moves
 ...
 * demand.
 *
 * .advance is a pure function of (plan, planStartedAtMs, nowMs) 鈥?no hidden
 * state 鈥?which makes it deterministic and unit-testable with a fake clock (see
...
final class CoarseExecutor {
     ...
     * Returns the interpolated position and whether the trip is finished. Cheap and idempotent 鈥?call

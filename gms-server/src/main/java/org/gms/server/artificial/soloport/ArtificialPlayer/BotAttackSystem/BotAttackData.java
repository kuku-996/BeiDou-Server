...
public final class BotAttackData {
    ...
    /**
     * A universally present, non-skill body action.  Training bots are cloned from a
     * headless template and therefore do not own the skills their decorative job
     * implies.  v83 can render those forged skill actions as a death/rope state on
     * some clients.  This neutral swing is used by the safe training renderer until
     * a bot has a real learned-skill packet path.
     */
    public static int safeNeutralAction() {
        return SWING_O1;
    }

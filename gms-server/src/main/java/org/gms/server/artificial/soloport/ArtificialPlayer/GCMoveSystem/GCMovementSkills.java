 ...
 *
 * Our bots are ephemeral decoration, so there are NO MP/meso gates and no skill-tree checks 鈥?MovementStyle-
 ...
 * map before scaling.
 *
 * Teleport is an instant blink (correct 鈥?a real teleport has no arc): it warps the bot and broadcasts the
 * cmd4/3/0 fragments here. Flash jump is NOT instant 鈥?it launches a real directional jump and arms
 * pendingFlashJump; the airborne integrator (BotPhysicsEngine.stepAirborne) injects the (卤550,-350) dash
 ...
 * is TIERED 鈥?flashJumpScale = level cap (FlashJumpTiers: young Hermit 0.75, NL/Hermit-100+ full) x
...
final class GCMovementSkills {
    ...
    // drift + dash), derived from the physics constants 鈥?calibrate with !gcmove fj before trusting the
    ...
    // 鈹€鈹€ Teleport (mage blink) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    // 鈹€鈹€ Flash Jump (thief air dash) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    static boolean execFlashJump(BotMovementState st, Character bot, int targetX, float scaleCap) {
        ...
        if (origin == null || st.inAir || st.climbing) {
            return false; // no position, or already airborne/on a rope 鈥?don't stack a dash
        }
        int dir = targetX >= origin.x ? 1 : -1;
        // Pick the largest dash that fits the platform (and the level cap). We do NOT warp to a landing
        // point 鈥?the airborne integrator lands the bot naturally; the fit just guarantees the chosen arc
        ...
        if (scale <= 0f) {
            return false; // no arc fits the remaining run 鈥?caller walks (or uses the plain engage hop)
        }
        ...
        // Faithful GreenCatMS flash jump 鈥?NOT an instant snap.
    ...
    // 鈹€鈹€ Landing math (foothold-only; ported concept from BotPhysicsEngine.teleportLanding) 鈹€鈹€

    // Nearest same-level (卤ySnap) foothold up to `range` px toward `dir`, stepping the reach inward if the
    ...
    // 鈹€鈹€ Broadcast (client-verified fragment layouts; see the Fable handoff doc Appendix A) 鈹€鈹€
    ...
    // cmd 3/4: authored for the v83 CLIENT decode 鈥?x,y,fh,stance,elapse(=0 blink) 鈥?NOT the server parse

...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotMovementSystem.MovementCommands.injectArtificialStopPacket;
...
public class PlayerReaction {
     ...
     * MidMovementCheck callback on the replay thread 鈥?the replay is paused
    ...
    public static PlayerSnapshot executeStopReaction(Character bot, Character player) {
        ...
        // Visually stop the bot 鈥?don't use interruptBotMovement() here because
     ...
     * specifically 鈥?just doing something flavorful while walking.
     */

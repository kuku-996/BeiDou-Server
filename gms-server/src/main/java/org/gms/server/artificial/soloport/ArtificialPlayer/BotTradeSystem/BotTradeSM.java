...
import org.gms.server.artificial.soloport.ArtificialPlayer.BotBlockList;
...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotCommandsPack.SocialCommands.BotTradeSpeak;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotHelpers.convertItemIdToName;
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotTradeSystem.BotTradeCommands.getTradePartnerCharacter;
...
import static org.gms.server.artificial.soloport.itemPool.ItemUtilities.isEquip;
        ...
        switch (getTradeState()) {
            ...
            case CLEANUP:
                ...
                if (lastTradeResult != Trade.TradeResult.SUCCESSFUL) {
                    BotEmote(getChr(), 4);
                    BotTradeSpeak(getChr(), "Why did you decline?");
                } else {
                    BotEmote(getChr(), 2);
                    BotTradeSpeak(getChr(), "Thank you!");

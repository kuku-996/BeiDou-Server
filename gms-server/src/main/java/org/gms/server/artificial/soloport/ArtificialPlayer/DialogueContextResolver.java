...
import org.gms.server.artificial.soloport.itemPool.ItemInformationProviderUtilities;
...
public final class DialogueContextResolver {
    ...
    // 鈹€鈹€ Subject-agnostic field resolvers (work for the bot or a player) 鈹€鈹€
    ...
    // 鈹€鈹€ Mob / drop helpers (bot's map) 鈹€鈹€

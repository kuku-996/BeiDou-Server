...
public class CharacterService {
    ...
    public Character loadCharFromDB(int cid, Client client, boolean channelServer) {
        ...
        chr.setOreStorage(OreStorage.loadOreStorage(cid));
        chr.setScrollStorage(OreStorage.loadScrollStorage(cid));
        chr.setChairStorage(OreStorage.loadChairStorage(cid));
        chr.setMountStorage(OreStorage.loadMountStorage(cid));

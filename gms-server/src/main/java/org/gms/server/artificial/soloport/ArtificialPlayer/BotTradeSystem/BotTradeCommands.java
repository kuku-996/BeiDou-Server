...
import static org.gms.server.artificial.soloport.ArtificialPlayer.BotLogic.generateCleanItemWithQty;
...
//        todo
    ...
    public static void writeTradeChat(Character fakechar, String message) {
        if (isValidTrade(fakechar)) {
            fakechar.getTrade().chat(SoloMaplingChineseLocalization.botSpeech(message, PhraseCategory.TRADE));
        }
    }
